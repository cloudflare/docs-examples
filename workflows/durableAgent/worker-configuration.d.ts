/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 31c87dea284aa53564315d6b95b05443)
// Runtime types generated with workerd@1.20260111.0 2025-04-16 nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		...
		ResearchAgent: DurableObjectNamespace<import("./worker/index").ResearchAgent>;
		RESEARCH_WORKFLOW: Workflow<Parameters<import("./worker/index").ResearchWorkflow['run']>[0]['payload']>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AI_GATEWAY_TOKEN" | "CF_ACCOUNT_ID" | "CF_GATEWAY_ID">> {}
}
